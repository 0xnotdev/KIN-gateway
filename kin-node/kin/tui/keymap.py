...
DEFAULT_KEYMAP: List[KeyBindingSpec] = [
    ...
    *[
    ...
    KeyBindingSpec(
        key="l",
        action="lane_notes",
        label="Private Notes Lane",
        priority=False,
        suppressed_when_text_focused=True,
        section="arena",
        scope="arena",
        justification="Printable letter 'l' opens the owner-only notes lane and yields to text input fields.",
    ),
    KeyBindingSpec(
        key="p",
        action="promote_private_note",
        label="Promote Selected Private Note",
        priority=False,
        suppressed_when_text_focused=True,
        section="arena",
        scope="arena",
        consequential=True,
        justification="Private-note promotion crosses the peer boundary and requires confirmation.",
    ),
    KeyBindingSpec(
        key="r",
        action="replay_item",
    ...
    KeyBindingSpec(
        ...
        section="arena",
        scope="arena",
        justification="Printable letter 'w' records a reviewed checkpoint and yields to text input fields.",
    ),
    KeyBindingSpec(
        key="y",
        action="record_decision",
        label="Record Owner Decision",
        priority=False,
        suppressed_when_text_focused=True,
        section="arena",
        scope="arena",
        justification="Printable letter 'y' records an owner decision and yields to text input fields.",
    ),
    KeyBindingSpec(
        key="h",
        action="create_playbook",
        label="Create Playbook from Outcome",
        priority=False,
        suppressed_when_text_focused=True,
        section="arena",
        scope="arena",
        justification="Printable letter 'h' creates a local reviewable template from a completed outcome.",
    ),
    KeyBindingSpec(
        key="m",
