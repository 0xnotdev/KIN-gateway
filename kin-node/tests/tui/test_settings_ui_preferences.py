...
from kin.tui.widgets.settings_screen import SettingsScreenWidget


@pytest.mark.asyncio
async def test_settings_ui_updates_persisted_preferences():
    """Assert preference changes from SettingsScreenWidget update app.prefs attributes."""
    app = KinApp(theme_name="kin-graphite", profile_name="test_profile_settings")
